<!-- This page displays the R Shiny app for analysis
	...
	if(array_key_exists('user_is_logged_in',$_SESSION) && $_SESSION['user_is_logged_in']){
	    ...
	    echo '<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">';
	      echo '<ul class="nav navbar-nav">';
	        ...
	        echo '<li class="active"><a href="analysis.php">Analysis<span class="sr-only">(current)</span></a></li>';
	      echo '</ul>';
	    ...
	    $url = "https://hobbes.colby.edu/jdong/analysis/?user=".$_SESSION['user_name'];
